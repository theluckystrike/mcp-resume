...
test.skip("cap: no row-capped write tool on this server", { skip: "resume has no row cap on a written file; its free limits are counts of stored records, covered by the server's own suites" }, () => {});
